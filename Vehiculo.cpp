...
double Vehiculo::total( int horaSalida,int minutosSalida ){
	return cobro -> total(horaSalida,minutosSalida,tonelaje);
}

double Vehiculo::getTotalPago ( ) {
	return cobro->getTotalPagar();
}
